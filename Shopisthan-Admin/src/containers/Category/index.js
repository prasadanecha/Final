...
const Category = (props) => {
    ...
    const handleClose = () => {
        ...
        from.append('categoryIcon', categoryImage);
    ...
    const renderCategories = (categories) => {
        ...
        for (let category of categories) {
            myCategories.push(
                {
                    label: category.name,
                    icon:  category.categoryIcon ? <img src= {category.categoryIcon.img} /> : null,
                    // label: category.name,
                    value: category._id,
...
if(checkedIdsArray.length>0){
    ...
    const categoryList = addCategoryList(category.categories);
    return (
        <Layout sidebar>
            <Container>
                <Row>
                ...
                <Row>
                    <Col md={12}>
                        ...
                        <div className="actionBtnContainer">
                            ...
                            <button onClick={()=>setShowLocationModal(true)}> <IoIosAdd/> <span>Add</span></button>
                               </div>
                          </div>
                    </Col>
